...
<div style="text-align: center">
    <h2 style="margin-left: -140px">Plan A</h2>
    <div class="row" style="max-width: 1000px;margin: 0 auto;">
        <div class="col-md-12">
            ...
            <div style="padding-top: 40px">
                <img src="../../images/step-arrow2.gif" alt="">
            </div>
    ...
    <!--plan b-->
<div>
    <h2 style="margin-left: -140px;margin-top: 100px">Plan B</h2>
    <p style="margin-left: -100px"> July to the end of November (Not Set yet)</p>
</div>
