...
<header class="htmleaf-header">
    ...
    <div class="htmleaf-links">
        <a class="htmleaf-icon icon-htmleaf-home-outline" href="index" title="index" target="_blank"><span> index</span></a>
        <a class="htmleaf-icon icon-htmleaf-arrow-forward-outline" href="login" title="login" target="_blank"><span> return login</span></a>
    </div>
</header>
<article class="htmleaf-content">
    <!-- multistep form -->
    <form id="msform" action="login">
        <!-- progressbar -->
        <ul id="progressbar" >
        ...
        <fieldset>
            ...
            <input type="password" name="cpass" placeholder="repeat" />
