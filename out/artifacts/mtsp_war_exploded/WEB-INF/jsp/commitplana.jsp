...
<head>
    ...
    <script>
        ...
        function jqchk(){ //jquery获取复选框值
            ...
            var exercise9 =[];
            var exercise10 =[];
            $('input[name="exercise1"]:checked').each(function(){
                exercise1.push($(this).val());
            });
            $('input[name="exercise2"]:checked').each(function(){
                exercise2.push($(this).val());
            });
            $('input[name="exercise3"]:checked').each(function(){
                exercise3.push($(this).val());
            });
            $('input[name="exercise4"]:checked').each(function(){
                exercise4.push($(this).val());
            });
            $('input[name="exercise5"]:checked').each(function(){
                exercise5.push($(this).val());
            });
            $('input[name="exercise6"]:checked').each(function(){
                exercise6.push($(this).val());
            });
            $('input[name="exercise7"]:checked').each(function(){
                exercise7.push($(this).val());
            });
            $('input[name="exercise8"]:checked').each(function(){
                exercise8.push($(this).val());
            });
            $('input[name="exercise9"]:checked').each(function(){
                exercise9.push($(this).val());
            });
            $('input[name="exercise10"]:checked').each(function(){
                exercise10.push($(this).val());
            });
            answer=exercise1+"  "+exercise2+"  "+exercise3+"  "+exercise4+"  "+exercise5+"  "+exercise6+"  "+exercise7+"  "+exercise8+"  "+exercise9+"  "+exercise10;
           console.log(answer);
            window.location = "commitAnswer?answer=" + answer;
        }
    </script>
...
<div style="text-align: center">
    <form action="">
        <h2>Submission of the answer to plan A round 1</h2>
        <div class="answer"><laybel style="margin-right: 50px">1.</laybel>A<input name="exercise1" type="checkbox" value="A">B<input  name="exercise1" type="checkbox" value="B">C<input  name="exercise1" type="checkbox" value="C">D<input  name="exercise1" type="checkbox" value="D"></div>
        <div class="answer"><laybel style="margin-right: 50px">2.</laybel>A<input name="exercise2" type="checkbox" value="A">B<input  name="exercise2" type="checkbox" value="B">C<input  name="exercise2" type="checkbox" value="C">D<input  name="exercise2" type="checkbox" value="D"></div>
        <div class="answer"><laybel style="margin-right: 50px">3.</laybel>A<input name="exercise3" type="checkbox" value="A">B<input  name="exercise3" type="checkbox" value="B">C<input  name="exercise3" type="checkbox" value="C">D<input  name="exercise3" type="checkbox" value="D"></div>
        <div class="answer"><laybel style="margin-right: 50px">4.</laybel>A<input name="exercise4" type="checkbox" value="A">B<input  name="exercise4" type="checkbox" value="B">C<input  name="exercise4" type="checkbox" value="C">D<input  name="exercise4" type="checkbox" value="D"></div>
        <div class="answer"><laybel style="margin-right: 50px">5.</laybel>A<input name="exercise5" type="checkbox" value="A">B<input  name="exercise5" type="checkbox" value="B">C<input  name="exercise5" type="checkbox" value="C">D<input  name="exercise5" type="checkbox" value="D"></div>
        <div class="answer"><laybel style="margin-right: 50px">6.</laybel>A<input name="exercise6" type="checkbox" value="A">B<input  name="exercise6" type="checkbox" value="B">C<input  name="exercise6" type="checkbox" value="C">D<input  name="exercise6" type="checkbox" value="D"></div>
        <div class="answer"><laybel style="margin-right: 50px">7.</laybel>A<input name="exercise7" type="checkbox" value="A">B<input  name="exercise7" type="checkbox" value="B">C<input  name="exercise7" type="checkbox" value="C">D<input  name="exercise7" type="checkbox" value="D"></div>
        <div class="answer"><laybel style="margin-right: 50px">8.</laybel>A<input name="exercise8" type="checkbox" value="A">B<input  name="exercise8" type="checkbox" value="B">C<input  name="exercise8" type="checkbox" value="C">D<input  name="exercise8" type="checkbox" value="D"></div>
        <div class="answer"><laybel style="margin-right: 50px">9.</laybel>A<input name="exercise9" type="checkbox" value="A">B<input  name="exercise9" type="checkbox" value="B">C<input  name="exercise9" type="checkbox" value="C">D<input  name="exercise9" type="checkbox" value="D"></div>
      <div class="answer"><laybel style="margin-right: 45px">10.</laybel>A<input name="exercise10" type="checkbox" value="A">B<input name="exercise10" type="checkbox" value="B">C<input name="exercise10" type="checkbox" value="C">D<input name="exercise10" type="checkbox" value="D"></div>
        <button class="btn btn-success" type="button" style="margin: 50px" id="submit">commit</button>
    </form>
</div>
