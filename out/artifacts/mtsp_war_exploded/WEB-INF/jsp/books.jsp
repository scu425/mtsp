...
<div id="content">
    <div class="row" style="max-width: 960px;padding: 35px 0;margin: 0 auto;">
        ...
        <div class="col-md-9" style="display: inline-block">
            <h3>Complex Analysis 2</h3>
            <p>Solution of the Boundary Value Problem by Means of the Schwarz Alternating Method Solution of the Boundary Value Problem by Means of the Schwarz Alternating Method Solution of the Boundary Value Problem by Means of the Schwarz Alternating Method </p>
            <a href="">show more</a>
        </div>
    </div>
    ...
    <div class="row" style="max-width: 960px;padding: 35px 0;margin: 0 auto;">
        ...
        <div class="col-md-9" style="display: inline-block">
            <h3>Structure Analysis 2</h3>
            <p>Solution of the Boundary Value Problem by Means of the Schwarz Alternating Method Solution of the BoundarSolution of the Boundary Value Problem by Means of the Schwarz Alternating Method Solution of the Boundar</p>
            <a href="">show more</a>
        </div>
    </div>
</div>
