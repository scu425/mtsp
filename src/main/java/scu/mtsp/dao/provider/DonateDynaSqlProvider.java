...
import static scu.mtsp.util.common.MtspConstant.DONATE;
...
public class DonateDynaSqlProvider {
     ...
     * @return
     */
    public String insertDonate(final Donate donate) {
        return new SQL() {
            {
                INSERT_INTO(DONATE);
     ...
     * @return
     */
    public String selectDonateWithParams(final Donate donate) {
        return new SQL() {
            {
                SELECT("*");
                FROM(DONATE);
     ...
     * @return
     */
    public String updateDonate(final Donate donate) {
        return new SQL() {
            {
                UPDATE(DONATE);
                WHERE("donate_id = #{donateId}");
