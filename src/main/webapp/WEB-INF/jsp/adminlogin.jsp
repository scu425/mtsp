    ...
    <div class="row myCenter">
        <div class="col-md-2 col-center-block">
            <form class="form-signin" action="/admincheck" method="post" >
                ...
                <a href="login"><button class="btn btn-success col-md-6" type="button"><< Ordinary User</button></a>
                <button class="btn btn-primary col-md-5 col-md-offset-1" type="submit" >Log in</button>
