...
<header class="container">
                ...
                <ul>
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="plan_a.jsp">Plan A</a></li>
    ...
    <div class="jumbotron" style="text-align: center">
        <h2>Plan A Exam Download</h2>
        <p>If you do not finish the test, click the button to download the test paper and complete it in one month. If you have completed the test paper, please click the submission button below.</p>
        <a href="../../file/plan_a_exam.pdf"><h4>Click Me To Start Download</h4></a>
        <a href="commitplana.html"><button class="btn btn-success">Commit Your Answer</button></a>
    </div>
